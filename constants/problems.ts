export interface Problem {
  ...
  explanation: string;
  difficulty: 1 | 2 | 3;
  distractors: string[]; // 오답 유도용 유사 계정
}
...
export const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    debit: { account: "단기차입금", amount: 3000000 },
    credit: { account: "보통예금", amount: 3060000 },
    explanation: "차입금 상환 시 원금(부채 감소)과 이자(비용 발생)를 함께 처리합니다. 이자비용도 차변에 기록됩니다.",
    difficulty: 2,
  ...
  },
  {
    ...
    credit: { account: "차량운반구", amount: 800000 },
    explanation: "처분가액 > 장부가액이므로 유형자산처분이익 200,000원이 발생합니다. 상품 외 자산 외상 처분은 미수금 사용.",
    difficulty: 2,
  ...
  // ── advanced (5개) ──
  {
    ...
    credit: { account: "지급어음", amount: 1000000 },
    explanation: "복합 결제: 어음 발행분은 지급어음, 나머지 외상은 외상매입금. 차변 합계 = 대변 합계 확인.",
    difficulty: 3,
    distractors: ["외상매입금", "현금", "미지급금", "받을어음"],
  },
  {
    id: "a02",
    category: "advanced",
    ...
    credit: { account: "예수금", amount: 200000 },
  ...
  },
  {
    ...
    explanation: "처분가액 < 장부가액이므로 유형자산처분손실 200,000원 발생. 현금 300,000(차변) + 처분손실 200,000(차변) = 비품 500,000(대변).",
    difficulty: 3,
  ...
  // ── practical (5개) ──
  {
    ...
    debit: { account: "임차료", amount: 1000000 },
    credit: { account: "보통예금", amount: 1100000 },
    explanation: "부가세 포함 거래. 공급가액은 임차료(비용), 부가세는 별도 처리. 실무에서 부가세 매입세액은 자산으로 처리할 수 있습니다.",
    difficulty: 2,
