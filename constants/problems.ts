...
export const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    text: "외화 선급금은 기말에 마감환율로 재환산한다.",
    answer: false,
    explanation: "선급금은 비화폐성 항목 → 거래일 환율로 계속 기록. 기말 재환산 없음.",
  ...
  },
  {
    ...
    text: "결손금 보전에 자본잉여금을 사용하면 총 자본이 감소한다.",
    answer: false,
    explanation: "결손금 보전: 자본 내부 이동. 자본잉여금 감소 + 이월결손금 감소 → 총 자본 불변.",
